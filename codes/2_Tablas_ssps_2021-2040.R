...
futuro_files <- list.files(paste0(ruta,"/ssp126_2021-2040"), full.names = TRUE, pattern = ".tif$");futuro_files
...
####ssp370####
# Definir los archivos de futuro y sus respectivos nombres de modelos
futuro_files <- list.files(paste0(ruta,"/ssp370_2021-2040"), full.names = TRUE, pattern = ".tif$")
...
####ssp585####
# Definir los archivos de futuro y sus respectivos nombres de modelos
futuro_files <- list.files(paste0(ruta,"/ssp585_2021-2040"), full.names = TRUE, pattern = ".tif$")
...
write.csv(results, paste0(ruta,"/MeanBio_2021-2040.csv"), row.names = F)
