...
calculate_stats <- function(raster, ensemble, name) {
  ...
  nombre_salida <- paste0("/Volumes/TOSHIBA EXT/COBERTURAS/WC/ssp126_2041-2060/deltasEnsamble/dE.", name, "_ssp126_2041-2060.tif")
  ...
  stats <- data.frame(Variable = paste("wc2_", 1:19, sep = ""),
                      ...
                      Year = "2041-2060",
                      SSP = "SSP1 2.6",
                      Tipo = "dBios_between_GCM_ssp126_2041-2060"
                      )
...
ensemble_stats1 <- data.frame(Variable = paste("wc2_", 1:19, sep = ""),
                             ...
                             Year = "2041-2060",
                             SSP = "SSP1 2.6",
                             Tipo = "d.Ensamble_GCM_ssp126_2041-2060"
                             )
...
calculate_stats <- function(raster, ensemble, name) {
  ...
  # Generar nombre de archivo de salida
  nombre_salida <- paste0("/Volumes/TOSHIBA EXT/COBERTURAS/WC/ssp370_2041-2060/deltasEnsamble/dE.", name, "_ssp370_2041-2060.tif")
  ...
  stats <- data.frame(Variable = paste("wc2_", 1:19, sep = ""),
                      ...
                      Year = "2041-2060",
                      SSP = "SSP3 7.0",
                      Tipo = "dBios_between_GCM_ssp370_2041-2060"
  )
...
ensemble_stats2 <- data.frame(Variable = paste("wc2_", 1:19, sep = ""),
                             ...
                             Year = "2041-2060",
                             SSP = "SSP3 7.0",
                             Tipo = "d.Ensamble_GCM_ssp370_2041-2060"
)
...
calculate_stats <- function(raster, ensemble, name) {
  ...
  # Generar nombre de archivo de salida
  nombre_salida <- paste0("/Volumes/TOSHIBA EXT/COBERTURAS/WC/ssp585_2041-2060/deltasEnsamble/dE.", name, "_ssp585_2041-2060.tif")
  ...
  stats <- data.frame(Variable = paste("wc2_", 1:19, sep = ""),
                      ...
                      Year = "2041-2060",
                      SSP = "SSP5 8.5",
                      Tipo = "dBios_between_GCM_ssp585_2041-2060"
  )
...
write.csv(Bios_between_GCM, "/Volumes/TOSHIBA EXT/COBERTURAS/WC/dBios_between_GCM_2041-2060.csv", row.names = FALSE)
...
ensemble_stats3 <- data.frame(Variable = paste("wc2_", 1:19, sep = ""),
                             ...
                             Year = "2041-2060",
                             SSP = "SSP5 8.5",
                             Tipo = "d.Ensamble_GCM_ssp585_2041-2060"
)
...
# Guardar los resultados en un archivo CSV
write.csv(ensemble_stats, paste0("/Volumes/TOSHIBA EXT/COBERTURAS/WC/ensamble_GCM_2041-2060.csv"), row.names = FALSE)
