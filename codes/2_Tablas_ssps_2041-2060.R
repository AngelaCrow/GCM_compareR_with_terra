...
futuro_files <- list.files(paste0(ruta,"/ssp126_2041-2060"), full.names = TRUE, pattern = ".tif$");futuro_files
results1 <- map_dfr(futuro_files, ~ {
  ...
  dplyr::mutate(Year = "2041-2060", 
                SSP = "SSP1 2.6", 
                Tipo = "medias_ssp126_2041-2060")

####ssp370####
# Definir los archivos de futuro y sus respectivos nombres de modelos
futuro_files <- list.files(paste0(ruta,"/ssp370_2041-2060"), full.names = TRUE, pattern = ".tif$")
results2 <- map_dfr(futuro_files, ~ {
  ...
  dplyr::mutate(Year = "2041-2060", 
                SSP = "SSP3 7.0", 
                Tipo = "medias_ssp370_2041-2060")

####ssp585####
# Definir los archivos de futuro y sus respectivos nombres de modelos
futuro_files <- list.files(paste0(ruta,"/ssp585_2041-2060"), full.names = TRUE, pattern = ".tif$")
results3 <- map_dfr(futuro_files, ~ {
  ...
  dplyr::mutate(Year = "2041-2060", 
                SSP = "SSP5 8.5", 
                Tipo = "medias_ssp585_2041-2060")

# Unir los resultados de cada ssp
results<-rbind(results1, results2, results3)

# Guardar los resultdos
write.csv(results, paste0(ruta,"/MeanBio_2041-2060.csv"), row.names = F)
